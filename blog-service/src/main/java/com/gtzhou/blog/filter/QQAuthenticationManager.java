...
import com.gtzhou.blog.domain.QQUser;
...
public class QQAuthenticationManager implements AuthenticationManager {
    ...
    public Authentication authenticate(Authentication auth) throws AuthenticationException {
        if (auth.getName() != null && auth.getCredentials() != null) {
            QQUser user = getUserInfo(auth.getName(), clientId, (String) (auth.getCredentials()));
    ...
    private QQUser getUserInfo(String accessToken, String clientId, String openId) {
